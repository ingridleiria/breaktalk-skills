...
| --- | --- | --- |
| 45 | [research-question-ideation](research-question-ideation/SKILL.md) | From topic to candidate questions with novelty check and feasibility triage |
| 46 | [research-design](research-design/SKILL.md) | A written one-page design before estimation: question, hypotheses, identification, kill criteria |
| 47 | [preregistration-and-analysis-plan](preregistration-and-analysis-plan/SKILL.md) | Specific enough that two analysts get the same result, written before outcomes are seen |
| 48 | [research-ethics-and-data-protection](research-ethics-and-data-protection/SKILL.md) | Consent that informs, anonymisation that survives combination, a data plan that is operational |
| 49 | [literature-verification](literature-verification/SKILL.md) | No citation enters a draft until verified; reviews built from an evidence matrix |
| 50 | [systematic-review-protocol](systematic-review-protocol/SKILL.md) | A registered protocol, search strings that rerun exactly, and counts that reconcile |
| 51 | [theoretical-framework-review](theoretical-framework-review/SKILL.md) | Referencial teórico built or diagnosed mechanism by mechanism, Consensus-grounded when connected |
